      ...
      <div className="container mx-auto px-6 max-w-5xl">
        <div className="text-center mb-20">
          ...
          <p className="text-gray-500 dark:text-white/40 text-xl font-light max-w-2xl mx-auto">
            We don't manage thousands. We build dozens. If you're ready to transition from creator to legend, we're ready to talk.
          </p>
        </div>
          ...
          <AnimatePresence mode="wait">
            {formState === 'success' ? (
              ...
              >
                ...
                <p className="text-gray-500 dark:text-white/50 text-xl mb-12">Our A&R team will review your content and strategy within 72 hours.</p>
                <button
              ...
              <form onSubmit={handleSubmit} className="space-y-10 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  <div className="space-y-3">
                    ...
                    <input required className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl px-8 py-5 focus:border-brand-magenta outline-none transition-all placeholder:text-gray-400 dark:placeholder:text-white/10 text-gray-900 dark:text-white" placeholder="e.g. Tunde Legend" />
                  </div>
                  <div className="space-y-3">
                    ...
                    <input required className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl px-8 py-5 focus:border-brand-magenta outline-none transition-all placeholder:text-gray-400 dark:placeholder:text-white/10 text-gray-900 dark:text-white" placeholder="instagram.com/username" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  <div className="space-y-3">
                    ...
                    <select required className="w-full bg-gray-50 dark:bg-brand-deep border border-gray-200 dark:border-white/10 rounded-2xl px-8 py-5 focus:border-brand-magenta outline-none transition-all appearance-none text-gray-900 dark:text-white">
                ...
                <div className="space-y-3">
                  ...
                  <textarea rows={5} className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl px-8 py-5 focus:border-brand-magenta outline-none transition-all placeholder:text-gray-400 dark:placeholder:text-white/10 text-gray-900 dark:text-white" placeholder="What is your ultimate career goal?" />
                </div>
