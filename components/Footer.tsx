...
const Footer: React.FC<FooterProps> = ({ onNavigate }) => {
  ...
  return (
    <footer className="bg-gray-100 dark:bg-brand-deep pt-48 pb-12 border-t border-gray-200 dark:border-white/5 transition-colors">
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-4 gap-16 mb-24">
            ...
            <div className="flex gap-6">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-12 h-12 rounded-2xl bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 flex items-center justify-center text-xs font-black text-brand-deep dark:text-white hover:bg-brand-magenta hover:text-white dark:hover:bg-brand-magenta dark:hover:text-white transition-all transform hover:-translate-y-1"
          ...
          <div>
            <h4 className="text-gray-900 dark:text-white font-black uppercase text-[10px] tracking-widest mb-10">Navigation</h4>
