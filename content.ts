...
export const TALENT_PROFILES: TalentProfile[] = [
  ...
  },
  {
    slug: 'wale-daniel',
    name: 'Wale Daniel',
    role: 'MC, Event Host & Media Personality',
    location: 'Nigeria',
    description:
      'A dynamic MC, Event Host, Red Carpet Host and Media Personality known for his engaging presence, sharp communication skills and ability to connect with diverse audiences.',
    biography: [
      'Wale Daniel is a dynamic MC, Event Host, Red Carpet Host and Media Personality known for his engaging presence, sharp communication skills and ability to connect with diverse audiences.',
      'With a natural flair for entertainment and conversation, Wale brings energy, professionalism and personality to every platform he steps on—whether hosting corporate events, social celebrations, red-carpet experiences, brand activations or media productions.',
      'His approach combines confidence, humour, audience interaction and excellent stage management, ensuring that every event feels engaging, well-paced and memorable.',
    ],
    specialties: ['Corporate Event Hosting', 'Red Carpet Hosting', 'Brand Activations', 'Stage Management', 'Media Presentations'],
    knownFor: [
      'Engaging and dynamic event hosting',
      'Sharp communication and audience connection',
      'Professional red-carpet hosting',
    ],
    portfolioHighlights: [
      'Corporate and social event hosting',
      'Red-carpet experiences',
      'Brand activations and digital campaigns',
    ],
    brandPackage: {
      idealFor: ['Corporate Events', 'Social Events', 'Brand Collaborations'],
      offerings: [
        ...
        'Digital campaigns',
        'Television and online show hosting',
      ],
      uniqueAdvantage: 'Combines confidence, humour, audience interaction and excellent stage management for memorable events.',
    },
    socials: [
